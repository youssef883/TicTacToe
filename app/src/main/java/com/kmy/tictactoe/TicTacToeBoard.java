...
public class TicTacToeBoard extends View {
    ...
    public TicTacToeBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            winningLineColor = typedArray.getInteger(R.styleable.TicTacToeBoard_winningLineColor,0);
        }
        finally {
            typedArray.recycle();
        }
    ...
    public void setUpGame(Button playAgain , Button home , TextView playerScreen , String[] names)
    {
        game.setPlayAgainBTN(playAgain);
        game.setHomeBTN(home);
        game.setPlayerTurn(playerScreen);
